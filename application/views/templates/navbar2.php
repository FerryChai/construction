        ...
        <nav class="z-depth-0 navbig light-blue darken-1 transisi" role="navigation">
            <div class="nav-wrapper">
                <div class="container" style="width:85%;">
                    <a href="#!" class="brand-logo left font-bold" data-aos="fade-up-right" data-aos-delay="600" style="letter-spacing: -0.2px; height: 50px; margin-right: 5px; margin-top: 10px;"><i></i>Kudus Karya Inti Megah</a>
