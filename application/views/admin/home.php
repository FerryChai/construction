        ...
        <div class="container">
            <div>
                <h2 data-aos="fade-up" class="font-bold section-header-p center deep-orange-text text-darken-2">Pelayanan
                    Kami
                    <a class="btn light-blue darken-1" href="<?= base_url(); ?>admin/edit/4">
                        Edit
                    </a>
                </h2>
            </div>
    ...
    <div class="grid-kuburan" style="padding-top:3%;padding-bottom: 4%;">
        <div class="container">
            ...
            <h2 data-aos="fade-up" class="font-bold section-header-p center deep-orange-text text-darken-2">
                Portofolio
                <a class="btn light-blue darken-1" href="<?= base_url(); ?>admin/edit/1">
                    Edit
                </a>
            </h2>
            ...
            <div style="margin-top:30px;" data-aos="zoom-out-up" data-aos-delay="200">
                ...
                <div class="col l12">
                    <div class="center">
                        <a href="<?= base_url(); ?>Admin/edit/1" class="btn btn-large btn-minimal font-bold"
    ...
    <div class="grid-kuburan" style="padding-top:3%;padding-bottom: 4%;">
        <div class="container">
            ...
            <h2 data-aos="fade-up" class="font-bold section-header-p center deep-orange-text text-darken-2">
                Gallery
                <a class="btn light-blue darken-1" href="<?= base_url(); ?>admin/edit/2">
                    Edit
                </a>
            </h2>
            ...
            <div data-aos="zoom-out-up" data-aos-delay="200" style="margin-top:30px;">
                ...
                <div class="col l12">
                    <div class="center">
                        <a href="<?= base_url(); ?>admin/edit/2" class="btn btn-large btn-minimal font-bold"
                            style="border-radius:30px ;animation-delay: 0.4s; margin-top:30px;"><i class="material-icons left">search</i>SEE MORE
                        </a>
                    </div>
                </div>
    ...
    <div class="grid-kuburan" style="padding-top:3%; padding-bottom: 4%;">
        <div class="container">
            ...
            <h2 data-aos="fade-up" class="font-bold section-header-p center deep-orange-text text-darken-2">Testimoni
                Pelayanan
                <a class="btn light-blue darken-1" href="<?= base_url(); ?>admin/edit/3">
                    Edit
                </a>
            </h2>
